...
p. the same mail options apply to cc and/or bcc

bc. {{groupmail>toemail=example@mail.com|ccuser=dokuwikiuser|bccgroup=dokuwikigroup}}
...
| toemail=... | a (list of) email address(es) to send email to. |
| touser=... | a (list of) dokuwiki user account names to send email to. |
| togroup=... | a (list of) dokuwiki group names to send email to. |
| ccemail=... | a (list of) email address(es) to carbon copy email to. |
| ccuser=... | a (list of) dokuwiki user account names to carbon copy email to. |
| ccgroup=... | a (list of) dokuwiki group names to carbon copy email to. |
| bccemail=... | a (list of) email address(es) to blind carbon copy email to. |
| bccuser=... | a (list of) dokuwiki user account names to blind carbon copy email to. |
| bccgroup=... | a (list of) dokuwiki group names to blind carbon copy email to. |
